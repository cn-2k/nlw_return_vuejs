<template>
  <section class="w-full">
    ...
    >
      <div class="flex w-full mx-auto text-left">
        <div class="relative inline-flex items-center mx-auto align-middle">
          <div class="text-center">
            <h1
              class="max-w-5xl text-2xl font-bold leading-none tracking-tighter text-zinc-100 md:text-5xl lg:text-6xl lg:max-w-7xl"
            >
              Long headline to turn <br class="hidden lg:block" />
              your visitors into users
            </h1>
            <p
              class="max-w-xl mx-auto mt-8 text-base leading-relaxed text-zinc-200"
            >
            ...
            >
              ...
              <div class="mt-3 rounded-lg sm:mt-0 sm:ml-3">
                <button
                  class="items-center block px-5 lg:px-10 py-3.5 text-base font-medium text-center text-zinc-300 transition duration-500 ease-in-out transform border-2 border-white shadow-md rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                >
                  See features
                </button>
              </div>
      ...
      <section id="intro">
        <div
          class="flex flex-col items-center justify-center pt-24 mx-auto rounded-lg lg:px-10 max-w-7xl"
        >
          <img
            class="object-cover object-center w-full rounded-xl"
            alt="hero"
            src="https://wickedblocks.dev/assets/images/placeholders/hero.webp"
          />
        </div>
      </section>
    </div>
